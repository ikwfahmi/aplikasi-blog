...
<head> 
 ...
 .header { background-color: #2C3E50; color: #ffffff; padding: 12px 20px; } 
 .header-title { font-size: 15px; font-weight: 500; margin: 0; } 
 .header-sub { font-size: 11px; color: #aaaaaa; margin: 0; } 
 .sidebar { width: 210px; min-height: calc(100vh - 52px); background-color: #ffffff; border-right: 1px solid #f0f0f0; padding: 16px 0; flex-shrink: 0; } 
 ...
 .avatar-name { font-size: 13px; font-weight: 500; color: #212529; margin: 0; } 
 .sidebar-label { font-size: 10px; color: #adb5bd; padding: 0 14px 8px; text-transform: uppercase; letter-spacing: 0.06em; font-weight: 600; } 
 .nav-item { padding: 9px 14px; font-size: 13px; color: #555555; border-left: 2px solid transparent; cursor: pointer; display: flex; align-items: center; gap: 8px; text-decoration: none; } 
 .nav-item:hover { background-color: #f4f4f9; color: #333333; } 
 .nav-item.active { background-color: #e8f5e9; color: #2e7d32; border-left-color: #4CAF50; font-weight: 600; } 
...
<body> 
 ...
 @csrf 
 <button type="submit" class="btn btn-sm w-100" style="background-color:#fff0f0; color:#c0392b; border: 1px solid #f5c6c6;"> Keluar </button> 
 </form> 
 </div> 
 </div> 
